...
WriteStream& operator<<(WriteStream& out, Plane& p) {
...
WriteStream& operator<<(WriteStream& out, Ray2& p) {
...
WriteStream& operator<<(WriteStream& out, Ray3& p) {
	return out << p.Direction << ' ' << p.Origin;
}
...
WriteStream& operator<<(WriteStream& out, Box& p) {
...
WriteStream& operator<<(WriteStream& out, Sphere& p) {
...
WriteStream& operator<<(WriteStream& out, Hull& p) {
